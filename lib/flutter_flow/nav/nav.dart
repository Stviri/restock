...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                color: Color(0xFFDF5623),
                child: Image.asset(
                  'assets/images/My_ChatGPT_image-Photoroom_(1).png',
                  fit: BoxFit.contain,
                ),
              ),
            )
      ...
      routes: [
        ...
        FFRoute(
          name: CategoryViewWidget.routeName,
          path: CategoryViewWidget.routePath,
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: CategoryViewWidget(
        ...
        FFRoute(
          ...
          asyncParams: {
            'docref': getDoc(['supermarkets'], SupermarketsRecord.fromSnapshot),
          },
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: StorePageWidget(
        ...
        FFRoute(
          ...
          asyncParams: {
            'productref': getDoc(
                ['product_discounts'], ProductDiscountsRecord.fromSnapshot),
          },
          builder: (context, params) => NavBarPage(
            initialPage: '',
