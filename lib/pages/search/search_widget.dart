...
class _SearchWidgetState extends State<SearchWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ProductDiscountsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductDiscountsRecord> searchProductDiscountsRecordList =
            snapshot.data!;
                    ...
                    children: [
                          ...
                          child: TextFormField(
                              ...
                              () async {
                                safeSetState(() {
                                  _model.simpleSearchResults = TextSearch(
                                    searchProductDiscountsRecordList
                                        .map(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'cqe9auc5' /* მოძებნე სასურველი პროდუქტი */,
                              ),
                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, listOfProductsIndex) {
                                  final listOfProductsItem =
                                      listOfProducts[listOfProductsIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 10.0, 0.0, 10.0),
                                    child: InkWell(
                      ...
                      if (_model.searchactive)
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final listOfProducts = _model.simpleSearchResults
                                  .toList()
                                  .take(25)
                                  .toList();
